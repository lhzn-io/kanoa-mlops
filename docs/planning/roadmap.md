...
- **vLLM Serving**: Docker-based inference for open-source models.
  ...
  - [ ] **LLaVa / GPT-OSS**: Evaluation of other multimodal candidates.
- **Hardware Support**:
...
| :--- | :--- | :--- | :--- |
| **NVIDIA RTX 5080 (eGPU)** | 16GB | Molmo 7B (4-bit), Gemma 3 12B (4-bit) | [✓] Verified |
| **NVIDIA RTX 4090** | 24GB | Gemma 3 27B (4-bit) | [ ] Planned |
| **GCP L4** | 24GB | Molmo 7B, Gemma 3 12B (FP16) | [ ] Planned |
